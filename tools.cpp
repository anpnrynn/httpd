...
int convertWeekDayToIndex ( char *wday ) {
    ...
    { return 0; }
    else if ( strncasecmp ( "mon", wday, 3 ) == 0 )
    { return 1; }
    else if ( strncasecmp ( "tue", wday, 3 ) == 0 )
    { return 2; }
    else if ( strncasecmp ( "wed", wday, 3 ) == 0 )
    { return 3; }
    else if ( strncasecmp ( "thu", wday, 3 ) == 0 )
    { return 4; }
    else if ( strncasecmp ( "fri", wday, 3 ) == 0 )
    { return 5; }
...
int convertMonthToIndex ( char *month ) {
    ...
    { return 0; }
    else if ( strncasecmp ( "feb", month, 3 ) == 0 )
    { return 1; }
    else if ( strncasecmp ( "mar", month, 3 ) == 0 )
    { return 2; }
    else if ( strncasecmp ( "apr", month, 3 ) == 0 )
    { return 3; }
    else if ( strncasecmp ( "may", month, 3 ) == 0 )
    { return 4; }
    else if ( strncasecmp ( "jun", month, 3 ) == 0 )
    { return 5; }
    else if ( strncasecmp ( "jul", month, 3 ) == 0 )
    { return 6; }
    else if ( strncasecmp ( "aug", month, 3 ) == 0 )
    { return 7; }
    else if ( strncasecmp ( "sep", month, 3 ) == 0 )
    { return 8; }
    else if ( strncasecmp ( "oct", month, 3 ) == 0 )
    { return 9; }
    else if ( strncasecmp ( "nov", month, 3 ) == 0 )
    { return 10; }
...
int convertHttpDateToNsprDate ( char *date, struct tm *eDate ) {
    ...
    if ( sscanf ( date, "%32[a-zA-Z], %d %32[a-zA-Z] %d %d:%d:%d GMT",
        ...
        proceed = 1;
    } else if ( sscanf ( date, "%32[a-zA-Z], %d-%32[a-zA-Z]-%d %d:%d:%d GMT",
                         tempWday, &hDate, tempMonth, &hYear, &hHour, &hMin, &hSec ) == 7 ) {
        proceed = 1;
    } else if ( sscanf ( date, "%32[a-zA-Z] %32[a-zA-Z] %d %d:%d:%d %d GMT",
